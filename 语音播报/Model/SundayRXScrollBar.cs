...
{
    class SundayRXScrollBar : UserControl
    {
    ...
    class MyScroll : HScrollBar
    {
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                return new Rectangle(this.Location.X,this.Location.Y,0,0);
            }
        }
        ...
        protected override void OnPaintBackground(PaintEventArgs pevent)
        {
            ...
            pevent.Graphics.DrawRectangle(Pens.Black, this.DisplayRectangle);
        }
    }
}
